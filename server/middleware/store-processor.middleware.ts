...
// Middleware para processar automaticamente lojas após o cadastro/atualização
export function processStoreMiddleware(req: Request, res: Response, next: NextFunction) {
...
export async function geocodeStore(storeId: number) {
  try {
...
export async function updateStorePlaceDetails(store: any) {
  try {
